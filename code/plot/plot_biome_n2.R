...
base_fn = "out.3.t163.f5.n_biomes_2"
...
plot_fn = paste(plot_fp, "figS5_", out_str,".ase.pdf",sep="")

n_biomes = 2

st_lbl = list("0"="Non-freezing",
              "1"="Freezing",
              "..."="...")
st_colors = c("red","darkblue","gray")
...
p1 = p1 + geom_tiplab(size=2.5, offset=0.5, color=tip_colors)
