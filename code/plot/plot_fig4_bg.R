...
plot_fn    = paste(fp, "code/plot/fig/ase/", base_fn, ".ase.pdf", sep="")
color_fn   = paste(fp, "code/plot/range_colors.n6.txt",sep="")
label_fn   = paste(fp, "code/plot/state_labels.txt", sep="")
tree_fn    = paste(fp, "output/", out_str, ".ase.tre", sep="")

# file names
#fp = "./" # edit to provide an absolute filepath
#plot_fn = paste(plot_fp, out_str, ".pdf", sep="")
...
x_start = 80                  # choose starting age (greater than x_phy)
